...
const PurchasingTable = ({ 
  ...
  const isAuthorized = ["SuperAdmin", "Supervisor"].includes(session?.user?.role);
                  ...
                  >
                    ...
                    <td className={`px-6 py-6 text-center border-b border-gray-50 ${isFirstInGroup ? 'pt-8' : 'pt-4'}`}>
                      <div className="inline-flex flex-col gap-1.5 items-center min-w-[120px]">
                        <div className="flex items-center gap-2 text-[9px] font-bold text-gray-500 bg-white px-3 py-1.5 rounded-xl border border-gray-100 w-full justify-start shadow-sm">
                        ...
                        {(req.status === 'APPROVED' || req.status === 'RECEIVED') ? (
                          <div className="flex items-center gap-2 text-[9px] font-bold text-green-600 bg-green-50 px-3 py-1.5 rounded-xl border border-green-100 w-full justify-start">
                        ...
                        {req.isReceived && (
                          <div className="flex items-center gap-2 text-[9px] font-bold text-blue-600 bg-blue-50 px-3 py-1.5 rounded-xl border border-blue-100 w-full justify-start">
...
export default memo(PurchasingTable);