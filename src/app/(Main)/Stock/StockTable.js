...
import { Package, Database, Trash2, ChevronDown, Layers, Eye } from 'lucide-react';
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-50">
              {currentData.length > 0 ? currentData.map((item) => {
                ...
                <tr>
                  <td colSpan="6" className="py-32 text-center text-slate-300 italic uppercase text-[10px] font-black tracking-[0.4em]">
                    Database Kosong
                  </td>
                </tr>
              )}
