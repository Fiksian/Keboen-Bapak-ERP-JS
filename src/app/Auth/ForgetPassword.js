          ...
          {!isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="relative group">
                  ...
                  <input
                    ...
                    /* Peningkatan: Teks lebih tebal (font-bold) dan warna placeholder lebih kontras */
            ...
            <div className="text-center py-4 animate-in fade-in zoom-in duration-300">
              ...
              <button 
                type="button"
                onClick={onNavigate}
                className="w-full py-3 bg-gray-900 text-white rounded-lg font-extrabold hover:bg-gray-800 transition-all shadow-md"
              >
                Back to Login
              </button>
            </div>
